    ...
    >
      <div className="max-w-5xl mx-auto">
        ...
        >
          ...
          >
            {skillsData.map((category, categoryIndex) => (
              ...
              >
                ...
                <div className="h-1 w-12 bg-gradient-to-r from-blue-600 to-purple-600 rounded mb-6" />
          ...
          <motion.div
            variants={itemVariants}
            className="bg-gradient-to-r from-blue-50 to-purple-50 dark:from-slate-800 dark:to-slate-700 rounded-xl p-8 text-center"
          >
            <p className="text-lg text-gray-700 dark:text-gray-300">
              Always learning and staying current with the latest cloud technologies and DevOps practices.
            </p>
          </motion.div>
        </motion.div>
      </div>
