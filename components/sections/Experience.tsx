        ...
        >
          ...
          >
            ...
            <p className="text-lg text-gray-600 dark:text-gray-400">
              A journey through cloud and DevOps excellence
            </p>
          </motion.div>
          ...
          >
            {/* Timeline line */}
            <div className="absolute left-8 top-0 bottom-0 w-1 bg-gradient-to-b from-blue-600 to-purple-600 hidden md:block" />
              ...
              >
                ...
                <div className="absolute left-0 top-0 md:left-0 md:top-6 w-16 h-16 md:w-auto md:h-auto md:left-1 md:top-6 hidden md:flex items-center justify-center -translate-x-7.5">
                  <motion.div
                    animate={{ scale: [1, 1.2, 1] }}
                    transition={{ duration: 2, repeat: Infinity, delay: index * 0.3 }}
                    className="w-5 h-5 bg-blue-600 rounded-full border-4 border-white dark:border-slate-900 shadow-lg"
                  />
                </div>

                {/* Content card */}
                <div className="md:ml-12 bg-white dark:bg-slate-800 rounded-xl p-6 border border-gray-200 dark:border-slate-700 hover:border-blue-500 dark:hover:border-blue-400 transition-colors shadow-md hover:shadow-lg">
